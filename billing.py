...
class BillClass:
    def __init__(self,root):
        ...
        #--title--
        img = Image.open("images/inventory system/bill_logo.png")
        img = img.resize((70, 70), Image.LANCZOS)  # Adjust the size if needed
        self.icon_title = ImageTk.PhotoImage(img)
        #self.icon_title=PhotoImage(file="images/inventory system/bill_logo.png")
        title=Label(self.root,text="Billing Area",image=self.icon_title,compound=LEFT,font=("Algerian",40,"bold"),bg="#010c48",fg="White",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)

        #--logout_button--
        self.icon_side_logout=PhotoImage(file="images/inventory system/logout.png")
        btn_logout=Button(self.root,text="Logout",image=self.icon_side_logout,compound=LEFT,padx=15,command=self.logout,font=("Times New Roman",14,"bold"),bg="#333C6C",activebackground="black",fg="white",activeforeground="#666D91",cursor="hand2").place(x=1150,y=10,height=50,width=150)
        ...
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("times new roman",15),bg="lightyellow").place(x=140,y=47,width=135,height=25)
        btn_search=Button(ProductFrame2,text="Search",command=self.search,font=("goudy old style",15,"bold"),bg="#2196f3",activebackground="#2196f3",fg="white",cursor="hand2").place(x=285,y=45,width=100,height=27)
        btn_show_all=Button(ProductFrame2,text="Show All",command=self.show,font=("goudy old style",15,"bold"),bg="#083531",activebackground="#31817b",fg="white",cursor="hand2").place(x=285,y=10,width=100,height=27)
        ...
        lbl_note=Label(ProductFrame1,text="Note: ' Enter 0 Quantity to remove product from the cart. '",font=("goudy old style",12,"bold"),anchor='w',bg="white",fg="red").pack(side=BOTTOM,fill=X)
        ...
        btn_clear_cart=Button(Add_CartWidgetsFrame,text="Clear",command=self.clear_cart,font=("times new roman",15,"bold"),bg="lightgray",activebackground="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
        btn_Add_cart=Button(Add_CartWidgetsFrame,text="ADD | Update Cart",command=self.add_update_cart,font=("times new roman",15,"bold"),bg="orange",activebackground="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)

        #=======billing area===========
        billFrame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        billFrame.place(x=953,y=110,width=410,height=410)

        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="#ff6568",fg="white").pack(side=TOP,fill=X)
        ...
        btn_print=Button(billMenuFrame,text="Print",command=self.print_bill,font=("goudy old style",15,"bold"),bg="lightgreen",activebackground="lightgreen",fg="white",cursor="hand2")
        btn_print.place(x=2,y=80,width=120,height=50)

        btn_clear_all=Button(billMenuFrame,text="Clear All",command=self.clear_all,font=("goudy old style",15,"bold"),bg="gray",activebackground="gray",fg="white",cursor="hand2")
        btn_clear_all.place(x=124,y=80,width=120,height=50)
        
        btn_generate=Button(billMenuFrame,text="Generate/Save Bill",command=self.generate_bill,font=("goudy old style",15,"bold"),bg="#009688",activebackground="#009688",fg="white",cursor="hand2")
